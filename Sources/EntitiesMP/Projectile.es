...
#define DEVIL_LASER_SPEED 120.0f
#define DEVIL_ROCKET_SPEED 90.0f
%}
...
void PlayerGrenade(void) {
  ...
  m_fFlyTime = 3.0f;
  m_fDamageAmount = 100.0f;
  m_fRangeDamageAmount = 200.0f;
  m_fDamageHotSpotRange = 5.0f;
  m_fDamageFallOffRange = 12.0f;
  m_fSoundRange = 15.0f;
  m_bExplode = TRUE;
...
void HeadmanRocketmanExplosion(void) {
  ESpawnEffect ese;
  FLOAT3D vPoint;
  FLOATplane3D vPlaneNormal;
  FLOAT fDistanceToEdge;
...
void WomanProjectileExplosion(void) {
  ESpawnEffect ese;
  FLOAT3D vPoint;
  FLOATplane3D vPlaneNormal;
  FLOAT fDistanceToEdge;
...
void BeastBigDebrisExplosion(void)
{
  ...
  eSpawnSpray.colBurnColor=C_WHITE|CT_OPAQUE;
  eSpawnSpray.fDamagePower = 2.0f;
  eSpawnSpray.fSizeMultiplier = 1.25f;
  eSpawnSpray.sptType = SPT_LAVA_STONES;
  eSpawnSpray.vDirection = en_vCurrentTranslationAbsolute/64.0f;
  eSpawnSpray.penOwner = this;
  penSpray->Initialize( eSpawnSpray);
...
void BeastBigProjectileExplosion(void)
{
  ...
  ese.colMuliplier = C_WHITE|CT_OPAQUE;
  ese.betType = BET_LIGHT_CANNON;
  ese.vStretch = FLOAT3D(2.25,2.25,2.25);
  SpawnEffect(GetPlacement(), ese);
...
procedures:
  ...
  Main(ELaunchProjectile eLaunch) {
    ...
    switch (m_prtType) {
      ...
      case PRT_HEADMAN_ROCKETMAN: HeadmanRocketmanExplosion(); break;
      case PRT_WOMAN_FIRE: WomanProjectileExplosion(); break;
